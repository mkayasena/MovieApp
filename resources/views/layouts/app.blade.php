...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:title" content="Movie App | Laravel">
        <meta property="og:description" content="Movie App | Laravel">
        ...
        <nav class="border-b border-gray-880">
            <div class="container mx-auto px-4 flex-col md:flex-row flex items-center justify-between px-4 py-6">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <a href="#">
                            <img src="{{asset('images/avatar.jpg')}}" alt="avatar" class="rounded-full w-9">
                        </a>
                    </div>
                </div>
            </div>
